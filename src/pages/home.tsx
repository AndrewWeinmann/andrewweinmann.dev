...
const currently = [
	...
	{ label: "reading", value: "Dungeon Crawler Carl series" },
	{ label: "playing", value: "Palworld, Slay the Spire II, and Factorio" },
	{ label: "learning", value: "AI coding techniques" },
	{ label: "enjoying outdoors", value: "disc golf and biking" },
];
